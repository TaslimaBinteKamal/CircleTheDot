...
public class GameModel implements Cloneable{
   ...
   /**
    ...
    public GameModel clone(){
      int[][] clonedmodel= new int[sizeOfGame][sizeOfGame];
      ...
      Point temp= this.getCurrentDot();
      
      GameModel thecloned= new GameModel(sizeOfGame);
      thecloned.setCurrentDot(temp.getX(),temp.getY());
      thecloned.model=clonedmodel;
      return thecloned;
